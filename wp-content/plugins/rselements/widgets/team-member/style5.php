					...
					<div class="team-item">
						<div class="team-inner-wrap">
							<div class="image-wrap">
								<a  href="<?php echo esc_url( $link );?>" <?php echo esc_html( $popup_box );?>>
									<?php the_post_thumbnail($settings['thumbnail_size']); ?>
								</a>   
							</div>	
							<div class="team-content">
								<div class="member-desc">
									<h3 class="team-name"><a  href="<?php echo esc_url( $link );?>" <?php echo esc_html( $popup_box );?>><?php the_title();?></a></h3>

...
final class Rsaddon_Elementor_Pro_Extension {
	...
	public function init() {
		...
		add_action( 'elementor/elements/register', [ $this, 'add_category' ] );
	...
	public function init_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_pro_Mulimage_hover_Widget() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Pro_thumbnail_slider_Widget() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Image_Comparison_Pro_Widget() );
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_pro_Image_hover_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Pro_Event_Grid_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Pro_Notice_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Pro_CircleRipple_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Events_Sliders_Pro_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Events_Grid_Pro_Widget() );
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Events_Filter_Pro_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_RSNewsLetter_Widget() );	
        
        \Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_fancy_icons_Box_Widget() );	
        if ( class_exists( 'LearnPress' ) ) {
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_Course_Category_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_Course_Grid_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Course_Slider_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_cates_Slider_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_RScourses_search_Widget() );	
		}

		if(class_exists( 'SFWD_LMS' )){

			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_prold_Course_Category_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Pro_Learndash_Course_Grid_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Course_Slider_dash_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Cates_Ld_Slider_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_RScourses_search_dash_Widget() );
		}

		if ( function_exists('tutor')) {
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_Tutor_course_category_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_Tutor_Category_Slider_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_Tutor_Course_Grid_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Rsaddon_Elementor_pro_RScourses_search_tutor_Widget() );
		}
